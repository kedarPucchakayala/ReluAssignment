...
const Header = () => {
  return (
   <header className='header'>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" className='icon'>
    ...
    <div className="text">Search here...</div>
    <div className="menu">
    <svg id="Component_39_2_" data-name="Component 39 (2)" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" className='filter'>
  ...
  <g id="Group_26" data-name="Group 26">
    ...
    <div className="seller"><div className="Sell">Become A Seller</div></div>
